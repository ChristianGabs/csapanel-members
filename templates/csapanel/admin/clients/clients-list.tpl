				...
				if (totalpages > 0) {
					$('#pagination').bootstrapPaginator({
						...
						onPageClicked: function(event, originalEvent, type, page) {
							$.ajax({
								url: 'clients.php?mode=pagination&search=' + $('input[name=search]').val() + '&page=' + page,
								success: function(html) {
...
<div style="float:right;">
    {if in_array("addclient", $smarty.session.permissions)}
        <a href="clients.php?mode=add" class="btn btn-primary"><i class="fa fa-plus"></i> {$lang.addclient}</a>
    {/if}
</div>
...
<div class="panel panel-primary">
	...
	<div class="panel-body">
		<div id="searchresults">
			{include file='admin/clients/ajax-clientlist.tpl'}
		</div>
