...
!function($) {
    ...
    BootstrapDialog.ICON_SPINNER = 'fa fa-spinner';
    ...
    BootstrapDialog.prototype = {
        ...
        createModalBody: function() {
            ...
            {
                return $('<div class="modal-body" style="overflow:auto; max-height: '+this.options.height +'"></div>');
            }
            else
            {
        ...
        createButton: function(button) {
            ...
            $button.on('click', {dialog: this, button: button}, function(event) {
                ...
                if (button.autospin) {
                    ...
                    $button.prepend(dialog.createButtonIcon(dialog.getSpinicon()).addClass('fa-spin'));
                }
            });
